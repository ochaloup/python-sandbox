...
# from https://rxpy.readthedocs.io/en/latest/get_started.html#operators-and-chaining
...
def intense_calculation_err(value):
    if value > 200:
        raise Exception('aaaabbbccc')
...
rx.interval(1).pipe(
    ...
    ops.map(lambda s: intense_calculation_err(s)),
).subscribe(
